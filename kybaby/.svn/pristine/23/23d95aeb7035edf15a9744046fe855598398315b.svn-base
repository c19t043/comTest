...
public class MommySubscribeUserDaoImpl extends HibernateDaoSupport implements MommySubscribeUserDao {
	...
	public MommySubscribeUser getSomeUserSubscribeUser(long userId, long ringTypeId) {
	...
	public void addSomeUserSubscribeUser(MommySubscribeUser subscribeUser) {
	...
	public void deleteSomeUserSubscribeUser(MommySubscribeUser subscribeUser) {
