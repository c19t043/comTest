...
$(function () {
    ...
    $.ajax({
        ...
        cache:false,
        async:false,
        data:{action:"getAllFdServiceAnyThing"},
        success:function(result){
            ...
            if(result.fdUserBuyRecordList != null && result.fdUserBuyRecordList.length!=0){
                ...
                for (var i = 0; i < length; i++) {
                    ...
                    '<div class="doctor_introduction"><p>'+teamName+'</p>'+'<p>'+fdUserBuyRecordList.servicePackage.hospitalBasicInfo.hospitalLname+'</p>' +
                    ...
                    for (var j = 0; j < length2; j++) {
                        ...
                        $('.family_doctor_list').eq(i).append('<div onclick="window.location.href = \''+fdServiceItemsList.url+'?'+fdUserBuyRecordList.servicePackage.id+'\'"><img src="'+photo+fdServiceItemsList.imagePath+'"/><p>'
