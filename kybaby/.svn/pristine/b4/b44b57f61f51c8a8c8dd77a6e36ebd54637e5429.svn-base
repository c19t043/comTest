            ...
            <div id="body" style="clear:left">
                <dl class="content">
					...
					<dd>
						...
						<input size="30" name="WIDseller_email" value="guoyushan@yishangkeji.cn"/>
						<span></span>
					</dd>
					<dt>商户订单号：</dt>
					<dd>
						<span class="null-star">*</span>
						<input size="30" name="WIDout_trade_no" value="1277278"/>
						<span></span>
					</dd>
					<dt>订单名称：</dt>
					<dd>
						<span class="null-star">*</span>
						<input size="30" name="WIDsubject" value="test"/>
						<span></span>
					</dd>
                    <dt>付款金额：</dt>
                    <dd>
        ...
        <div id="foot">
			<ul class="foot-ul">
				...
				<li>
					...
					var alipayurl = host + "alipay/alipayapi.jsp?WIDseller_email=guoyushan@yishangkeji.cn&WIDout_trade_no=" + timestamp + "&WIDsubject=reshxg&WIDtotal_fee=" + allPrice;
				</li>
			</ul>
		</div>
	</div>
