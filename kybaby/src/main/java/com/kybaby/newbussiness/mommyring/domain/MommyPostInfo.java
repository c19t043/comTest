...
public class MommyPostInfo implements java.io.Serializable {
	...
	/** default constructor */
	public MommyPostInfo() {
	}

	/** full constructor */
	public MommyPostInfo(Long typeId, String title, String content, String postImg,
