...
public interface MommySubscribeUserDao {
	 ...
	 * @return 医生订阅医生圈的实例
	 */
	MommySubscribeUser getSomeUserSubscribeUser(long userId,long ringTypeId);
	 ...
	 */
	void addSomeUserSubscribeUser(MommySubscribeUser subscribeUser);
	 ...
	 */
	void deleteSomeUserSubscribeUser(MommySubscribeUser subscribeUser);
}
