...
public class SpAppointmentRecord implements java.io.Serializable {
	...
	private String recordIsfree;
	private String optime;
	private String no;
	private String add;
	//-----------------------------------------返回值
	private String registeNo;;//挂号单号
	...
	public String getRecordIsfree() {
		return this.recordIsfree;
	}

	public void setRecordIsfree(String recordIsfree) {
		this.recordIsfree = recordIsfree;
	}
