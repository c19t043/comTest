...
public class DateManage {
	 ...
	 * @return
	 */
	public static DateCalculate getMothAndDays(String startDate,String endDate){
		DateCalculate dateCalculate = DateCalculate.calculate(startDate, endDate);
	...
	public static void main(String[] args) {
		DateCalculate dateCalculate = DateManage.getMothAndDays("2011-03-31", "2012-05-13");
		System.out.println("月差为: " + dateCalculate.getDifferenceOfMonths());
		System.out.println("天差为: " + dateCalculate.getDifferenceOfDays());
	}
}
