...
public class EncryptUtil {
	...
	//add by fkn
	private static boolean saveImageToDisk(byte[] data,String imageName) throws IOException{
		// 写入到文件
