	...
	if(AlipayNotify.verify(params)){//验证成功
		...
		if(trade_status.equals("TRADE_FINISHED")){
			...
			//判断该笔订单是否在商户网站中已经做过处理
				...
				//如果有做过处理，不执行商户的业务程序
                               System.out.println("******************************");
                               String turnUrl="http://dev.qiyico.com/main/orderManage.action?action=paySuccess&orderNum="+out_trade_no;
			...
			System.out.println("*****************notify_url:mes= "+mes);
						if(mes.equals("操作成功")){
				//处理成功之后，开始向用户发送通知短信
				String userMessage="http://dev.qiyico.com/main/sendMessage.action?action=toUser&sendWords=预约&orderNum="+out_trade_no;
				...
				String docMessage="http://dev.qiyico.com/main/sendMessage.action?action=toDoctor&sendWords=预约&orderNum="+out_trade_no;
