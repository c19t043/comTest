	...
	if(AlipayNotify.verify(params)){//验证成功
		...
		if(trade_status.equals("TRADE_FINISHED")){
			...
			//判断该笔订单是否在商户网站中已经做过处理
				...
				//如果有做过处理，不执行商户的业务程序
         	System.out.println("******************************");
     		String turnUrl="http://dev.qiyico.com/memberManage/memberPaySuccess.action?action=paySuccessMemberBuyInfo&memberBuyInfo.orderNum="+out_trade_no+"&memberBuyInfo.useRemainBalance="+useBalanceAll+"&memberBuyInfo.discountMoney="+useDiscountMoney+"&userInfo.id="+userId+"&product.id="+productId;
