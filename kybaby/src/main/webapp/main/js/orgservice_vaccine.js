...
$(function () {
    ...
    $.ajax({
        ...
        success: function (result) {
            if (result.mes == '请登录') {
                ...
                iscurrentUserIdentity=result.currentUserIdentity;
            }
        },
        error: function () {
            layer();
    ...
    $("#cbUserAgreement").click(function () {
        ...
        //if($(this).parent("#yuyuexuzhi").hasClass('cbUserAgreement')){
        //    $(this).css('background','#272636');
        //}else{
        //    $(this).css('background','../images/images_family_doctor/readed.png');
        //};
    });
//  立即预约
