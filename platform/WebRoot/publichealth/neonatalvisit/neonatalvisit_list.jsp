	...
	<head>
		...
		<script type="text/javascript">
			...
			function doDetail(id) {
				action = "${pageContext.request.contextPath}/publichealth/neonatalvisit/toDetail.action";
				window.location.href=action +"?accountId="+$j("#accountId",parent.document).val()
						+"&phNeonatalVisitRecord.id="+id;
			}
			// 新增信息 
			function doAdd(action) {
				...
				$j("#toAdd").click(function(){
					...
					if(babyId){
						action = "${pageContext.request.contextPath}/publichealth/neonatalvisit/toAddPhNeonatalVisitRecord.action";
						window.location.href=action+"?accountId="+$j("#accountId",parent.document).val();
					}else{
						alert("没有宝宝可以添加记录");
						window.location.href = "${pageContext.request.contextPath}"
							+"/publichealth/neonatalvisit/toList.action"
						...
						<table width="98%"  border="0" cellpadding="0" cellspacing="0" class="text3">
							<tr>
								...
								<td width="10%" align="left">
									<input type="text" name="phNeonatalVisitRecord.name" id="name" value="" class="text3">
								</td>
					...
					<div class="eXtremeTable">
						<s:if test="#request.list.size>0">
							<com.java.ec:table items="list" var="p" tableId="list" border="0"
								action="${pageContext.request.contextPath}/publichealth/neonatalvisit/toList.action?accountId=${p.familyAccountInfo.id }"
								...
								<com.java.ec:row>
									...
									<com.java.ec:column property="name" title="宝宝姓名" width="10%"/>
									...
									<com.java.ec:column property="null" title="操作" width="10%">
										<a href="javascript:void();" title="宝宝详细信息" onclick="doDetail('${p.id}')">
