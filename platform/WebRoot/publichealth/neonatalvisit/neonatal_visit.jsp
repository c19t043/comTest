...
<script type="text/javascript">
	...
	function doSubmit() {
		confirmMsg(
				...
				function(tp) {
					if (tp == 'ok') {
						$('form_handle').action = "${pageContext.request.contextPath}"
							+"/publichealth/neonatalvisit/doSubmit.action";
						doHandle();	
					}
				});
	}
		...
		<div class="wz_right">
			<div class="but01">
				<div class="pop_button_bar">
					...
					<span><a href="javascript:doSubmit();"
						class="pop_button_blue">提交</a></span>
