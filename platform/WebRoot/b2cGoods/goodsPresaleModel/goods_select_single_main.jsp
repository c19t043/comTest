...
var $j = jQuery.noConflict(); 
	...
	window.addEvent('domready', function(){
		...
		if($chk(names)) {
			insertObject(ids,names);
		}
		
		$('addObjectButton').addEvent("click", select);
		$('objectIframe').src = "${pageContext.request.contextPath}/b2cGoods/goodsManager/getGoodsInfoList.action?flag=select";
	});
	
	var object = function(names,ids){
		this.name = names;
		this.id = ids;
	}
