		...
		<table width="100%" height="45"  border="0" cellpadding="1" cellspacing="1" bgcolor="#B7C6DD">
			<tr align="center" valign="middle" bgcolor="#F6F9FE">
				<td height="43" align="center" class="text3">
					<s:form action="b2cGoods/goodsPresaleModelManager/getPresaleModelList.action" name="query_list_form" id="query_list_form" theme="simple">
						<table width="98%"  border="0" cellpadding="0" cellspacing="0" class="text3">
							<tr>
<!-- 								<td width="8%" height="41" align="right">名称：</td> -->
<!-- 								<td width="12%" align="left"> -->
<!-- 									<input name="b2cGoodsDeliver.dname" id="b2cGoodsDeliver.dname" type="text" class="input1" value="${b2cGoodsDeliver.dname}"/>		 -->
<!-- 								</td> -->
					...
					<div class="eXtremeTable">
						<s:if test="#request.list.size>0">
							<com.java.ec:table items="list" var="o" tableId="list" border="0"
								action="${pageContext.request.contextPath}/b2cGoods/goodsPresaleModelManager/getPresaleModelList.action"
								...
								<com.java.ec:row>
									...
									<com.java.ec:column property="b2cGoods.goodsName" title="商品名称" width="10%"/>
									<com.java.ec:column property="prePrice" title="预订价格" width="5%"/>
									<com.java.ec:column property="isEnable" title="是否有效" width="5%"/>
                                    <com.java.ec:column property="startSaleDate" title="开售时间" width="10%"/>
								</com.java.ec:row>
							</com.java.ec:table>
						</s:if>
						<s:else>
...
<script type="text/javascript">
	...
	function doEdit(action) {
		...
		window.location.href=action + "?b2cGoodsPresaleModel.id="+items;
	}
</script>