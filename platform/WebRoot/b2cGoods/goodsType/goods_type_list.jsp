		...
		<table width="100%" height="45"  border="0" cellpadding="1" cellspacing="1" bgcolor="#B7C6DD">
			<tr align="center" valign="middle" bgcolor="#F6F9FE">
				<td height="43" align="center" class="text3">
					<s:form action="b2cGoods/goodsTypeManager/getGoodsTypeList.action" name="query_list_form" id="query_list_form" theme="simple">
						<table width="98%"  border="0" cellpadding="0" cellspacing="0" class="text3">
							<tr>
								<td width="8%" height="41" align="right">分类名称：</td>
								<td width="12%" align="left">
									<input name="b2cGoodsType.typeName" id="b2cGoodsType.typeName" type="text" class="input1" value="${b2cGoodsType.typeName}"/>		
								</td>
					...
					<div class="eXtremeTable">
						<s:if test="#request.list.size>0">
							<com.java.ec:table items="list" var="o" tableId="list" border="0"
								action="${pageContext.request.contextPath}/b2cGoods/goodsTypeManager/getGoodsTypeList.action"
								...
								<com.java.ec:row>
									...
									<com.java.ec:column property="typeName" title="分类名称" width="10%"/>
									<com.java.ec:column property="isEnable" title="是否有效" width="5%"/>
                                    <com.java.ec:column property="sort" title="排序号" width="5%"/>
								</com.java.ec:row>
							</com.java.ec:table>
						</s:if>
						<s:else>
...
<script type="text/javascript">
	...
	function doEdit(action) {
		...
		window.location.href=action + "?b2cGoodsType.id="+items;
	}
</script>