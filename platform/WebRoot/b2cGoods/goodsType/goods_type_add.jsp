...
<html>
	<head>
		...
		<script type="text/javascript" src="${pageContext.request.contextPath}/product/theme/winxp/resource/js/utils2.js"></script>
  		...
  		<script type="text/javascript">
	  		window.addEvent('domready', function(){
				...
				Util2.selectDistrict("b2cGoodsType.isEnable","b2cGoodsType.isMain");
			});
			...
			// 返回
		    function doBack(){
		    	var action = '<s:url namespace="/b2cGoods/goodsTypeManager" action="getGoodsTypeList" includeParams="true"/>';
  	...
  	<body>
		...
		<form id="form_add" class="form" action='<s:url namespace="/b2cGoods/goodsTypeManager" action="saveOrUpdateb2cGoodsType" includeParams="true"/>' method="post">
			<input name="save" id="save" type="submit" value="save" style="display: none;">
			<input name="b2cGoodsType.id" type="hidden" class="text3" size="40" value="${b2cGoodsType.id}">
			...
			<table width="100%" border="0" cellpadding="1" cellspacing="1" bgcolor="#B7C6DD">
				<tr align="center" valign="middle" class="text3">
					<td width="15%" height="32" align="right" bgcolor="#F6F9FE">分类名称<span class="text4">*</span>：</td>
					<td width="35%" height="32" align="left" bgcolor="#F6F9FE">
						&nbsp;&nbsp;
						<input name="b2cGoodsType.typeName" type="text" class="text3" size="40" value="${b2cGoodsType.typeName}">
					</td>
					<td width="15%" height="32" align="right" bgcolor="#F6F9FE">排序<span class="text4">*</span>：</td>
					<td width="35%" height="32" align="left" bgcolor="#F6F9FE">
						&nbsp;&nbsp;
						<input name="b2cGoodsType.sort" type="text" class="text3" size="40" value="${b2cGoodsType.sort}">
					</td>
				</tr>
				<tr align="center" valign="middle" class="text3">
					...
					<td width="35%" height="32" align="left" bgcolor="#F6F9FE">
						...
						<s:select list="#{'Y':'Y','N':'N'}" listKey="key" listValue="value" cssStyle="width:100px;" theme="simple"
								  name="b2cGoodsType.isEnable" value="b2cGoodsType.isEnable" />
					</td>
					<td width="15%" height="32" align="right" bgcolor="#F6F9FE"></td>
					<td width="35%" height="32" align="left" bgcolor="#F6F9FE">
						&nbsp;&nbsp;
					</td>
				</tr>
