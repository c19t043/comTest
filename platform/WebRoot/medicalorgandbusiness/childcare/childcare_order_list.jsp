		...
		<table width="100%" height="45"  border="0" cellpadding="1" cellspacing="1" bgcolor="#B7C6DD">
			<tr align="center" valign="middle" bgcolor="#F6F9FE">
				<td height="43" align="center" class="text3">
					<s:form action="/childcare/childCareOrderManager/getChildcareOrderList.action" name="query_list_form" id="query_list_form" theme="simple">
						<table width="98%"  border="0" cellpadding="0" cellspacing="0" class="text3">
							<tr>
								<td width="8%" height="41" align="right">订单编号：</td>
								<td width="12%" align="left">
									<input name="userChildcareAppointmentInfo.orderNum" id="userChildcareAppointmentInfo.orderNum" type="text" class="input1" value="${userChildcareAppointmentInfo.orderNum}"/>		
								</td>
								<td width="8%" height="41" align="right">宝宝姓名：</td>
								<td width="12%" align="left">
									<input name="userChildcareAppointmentInfo.userInfo.babyName" id="babyName" type="text" class="input1" value="${userChildcareAppointmentInfo.userInfo.babyName}"/>		
								</td>
								<td width="8%" height="41" align="right">医生姓名：</td>
								<td width="12%" align="left">
									<input name="userChildcareAppointmentInfo.doctorInfo.doctorName" id="doctorInfo.doctorName" type="text" class="input1" value="${userChildcareAppointmentInfo.doctorInfo.doctorName}"/>		
								</td>
								<%-- <td width="8%" height="41" align="right">订单状态：</td>
								<td width="12%" align="left">
									<s:select cssStyle="width:100px;" cssClass="text3" list="#{'':'请选择','已预约':'已预约','用户取消':'用户取消','未付款':'未付款','已会面':'已会面','已完成':'已完成'}" listKey="key" listValue="value" 
										theme="simple" name="userChildcareAppointmentInfo.status" value="userChildcareAppointmentInfo.status"/>
								</td> --%>
								<td width="8%" height="41" align="right">门诊时间：</td>
								<td width="12%" align="left">
									<input type="text" name="userChildcareAppointmentInfo.organChildcareOpenResources.openDate" value="${userChildcareAppointmentInfo.organChildcareOpenResources.openDate}"
					...
					<div class="eXtremeTable">
						<s:if test="#request.list.size>0">
							<com.java.ec:table items="list" var="o" tableId="list" border="0"
								action="${pageContext.request.contextPath}/childcare/childCareOrderManager/getChildcareOrderList.action"
								...
								<com.java.ec:row>
									...
									<com.java.ec:column property="organChildcareOpenResources.openDate" title="门诊日期" width="5%"/>
									<com.java.ec:column property="hospitalBasicInfo.hospitalLname" title="门诊机构" width="10%"/>
									<com.java.ec:column property="organChildcareOpenResources.openStartTime" title="开始时间" width="5%"/>
									<com.java.ec:column property="organChildcareOpenResources.openEndTime" title="结束时间" width="5%"/>
                                    <com.java.ec:column property="null" title="医生姓名" width="5%">
                                    	${not empty o.doctorInfo.doctorName ? o.doctorInfo.doctorName : "李慧明"}
                                    </com.java.ec:column>
                                    <com.java.ec:column property="userInfo.babyName" title="宝宝姓名" width="5%"/>
                                    <%-- <com.java.ec:column property="status" title="订单状态" width="5%"/> --%>
								</com.java.ec:row>
							</com.java.ec:table>
						</s:if>
						<s:else>
...
<script type="text/javascript">
	...
	function doEdit(action) {
		...
		window.location.href=action + "?userChildcareAppointmentInfo.id="+items;
	}
</script>