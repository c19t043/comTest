...
<html>
	<head>
		...
		window.addEvent('domready', function(){
			...
			var id = parent.set_pro_Object_list[0].id;
			if(id){
				for(var i=0;i<allItems.length;i++){
					if(allItems[i].value==id){
		...
		<table width="100%" height="45"  border="0" cellpadding="1" cellspacing="1" bgcolor="#B7C6DD">
			<tr align="center" valign="middle" bgcolor="#F6F9FE">
				<td height="43" align="center" class="text3">
										<s:form action="/medicalorgandbusiness/setpro/getParentPro.action" name="query_list_form" id="query_list_form" theme="simple">
						<table width="98%"  border="0" cellpadding="0" cellspacing="0" class="text3">
							<tr>
								<td width="10%" height="41" align="right">产品名称：</td>
								<td width="10%" align="left">
									<input type="text" name="organSetPro.proName" 
									value="${organSetPro.proName}" class="text3">
								</td>
					...
					<div class="eXtremeTable">
						<s:if test="#request.list.size>0">
							<com.java.ec:table items="list" var="m" tableId="list" border="0"
								action="${pageContext.request.contextPath}/medicalorgandbusiness/setpro/getParentPro.action"
								imagePath="${pageContext.request.contextPath}/product/theme/winxp/resource/js/ectable/images/table/*.gif"
								width="100%" retrieveRowsCallback="limit" sortRowsCallback="limit"
								filterable="false" autoIncludeParameters="true" sortable="false">
								<com.java.ec:row onclick="parent.insertObject('${m.id}','${m.proName}');">
									<com.java.ec:column property="id" alias="id_checkbox" cell="radio" headerCell="checkbox" width="5%"/>
									<com.java.ec:column property="proName" title="产品名称" width="10%"/>
									<com.java.ec:column property="proPrice" title="产品价格" width="10%"/>
									<com.java.ec:column property="null" title="用户类型" width="10%">
										${p.userType.typeName }
									</com.java.ec:column>
