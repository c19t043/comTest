		...
		<table width="100%" height="45"  border="0" cellpadding="1" cellspacing="1" bgcolor="#B7C6DD">
			<tr align="center" valign="middle" bgcolor="#F6F9FE">
				<td height="43" align="center" class="text3">
					<s:form action="/medicalorgandbusiness/setmeal/getOrgList.action" name="query_list_form" id="query_list_form" theme="simple">
						<table width="98%"  border="0" cellpadding="0" cellspacing="0" class="text3">
							<tr>
								<td width="10%" height="41" align="right">医院名称：</td>
								<td width="10%" align="left">
									<input type="text" name="hospitalBasicInfo.hospitalLname" 
									id="itemShowName" value="${hospitalBasicInfo.hospitalLname}" class="text3">
								</td>
				...
				<td>
					<div class="eXtremeTable">
						...
						<com.java.ec:table items="list" var="m" tableId="list" border="0"
								action="${pageContext.request.contextPath}/medicalorgandbusiness/setmeal/getOrgList.action"
								imagePath="${pageContext.request.contextPath}/product/theme/winxp/resource/js/ectable/images/table/*.gif"
								width="100%" retrieveRowsCallback="limit" sortRowsCallback="limit"
								filterable="false" autoIncludeParameters="true" sortable="false">
								<com.java.ec:row onclick="parent.insertObject('${m.id}','${m.hospitalLname}');">
									<com.java.ec:column property="id" alias="id_checkbox" cell="checkbox" headerCell="checkbox" width="5%"/>
									<com.java.ec:column property="hospitalLname" title="医院名称" width="10%"/>
									<com.java.ec:column property="address" title="医院地址" width="10%"/>
									<com.java.ec:column property="hospitalType" title="医院类型" width="10%"/>
									<com.java.ec:column property="hospitalNature" title="医院性质" width="10%"/>
								</com.java.ec:row>
							</com.java.ec:table>
						</s:if>
						<s:else>
