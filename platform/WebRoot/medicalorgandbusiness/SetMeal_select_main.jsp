...
<script type="text/javascript">
	...
	window.addEvent('domready', function(){
		...
		var serviceItemIdsName = environment.dialog.getOpener().$(getTextName()).value;
		var serviceItemIds = environment.dialog.getOpener().$(getHeddinId()).value;
		...
		$('objectIframe').src = "${pageContext.request.contextPath}/medicalorgandbusiness/setmeal/getOrgList.action";
	});
	...
	function select(){
		...
		var orgName =environment.dialog.getOpener().$(getTextName());
