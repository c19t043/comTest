...
// 				window.location.href=action;
			...
			function doUpdateOrder(id){
				window.location.href="${pageContext.request.contextPath}/medicalorgandbusiness/paediatrics/updateOrderStatus.action?orderInfoClinic.id="+id;
			}
			$j(function(){
				$j("#orderType option").each(function(){
					 if($j(this).val()=='${orderInfoClinic.orderType }')
						 $j(this).attr("selected","selected");
				});
				$j("#status option").each(function(){
					 if($j(this).val()=='${orderInfoClinic.orderStatus }')
						 $j(this).attr("selected","selected");
				});
			})		
		</script>
		...
		<table width="100%" height="45"  border="0" cellpadding="1" cellspacing="1" bgcolor="#B7C6DD">
			<tr align="center" valign="middle" bgcolor="#F6F9FE">
				<td height="43" align="center" class="text3">
					<s:form action="/medicalorgandbusiness/paediatrics/toList.action" name="query_list_form" id="query_list_form" theme="simple">
						<table width="98%"  border="0" cellpadding="0" cellspacing="0" class="text3">
							<tr>
								<td width="10%" height="41" align="right">门诊时间：</td>
								<td width="10%" align="left">
									<input type="text" name="orderInfoClinic.appointmentDate" 
									value="${orderInfoClinic.appointmentDate }" class="text3"
								...
								<td width="10%" align="left">
									<input type="text" name="orderInfoClinic.doctorInfo.doctorName"  
									value="${orderInfoClinic.doctorInfo.doctorName}" class="text3">
								</td>
								
								<td width="10%" height="41" align="right">订单类型：</td>
								<td width="10%" align="left">
									<select id="orderType" name="orderInfoClinic.orderType" style="width:100px">
											<option value=""></option>
								...
								<td width="10%" align="left">
									...
									<select id="status" name="orderInfoClinic.orderStatus" style="width:100px">
											<option value=""></option>
					...
					<div class="eXtremeTable">
						<s:if test="#request.list.size>0">
							<com.java.ec:table items="list" var="p" tableId="list" border="0"
								action="${pageContext.request.contextPath}/medicalorgandbusiness/paediatrics/toList.action"
								...
								<com.java.ec:row>
									...
									<com.java.ec:column property="appointmentDate" title="门诊时间" width="10%">
									</com.java.ec:column>
									...
									<com.java.ec:column property="orderStatus" title="状态" width="10%"/>
									<com.java.ec:column property="null" title="操作" width="10%">
										<a href="javascript:void();" onclick="doUpdateOrder('${p.id}')">确认完成</a>
									</com.java.ec:column>
								</com.java.ec:row>
							</com.java.ec:table>
						</s:if>
