		...
		<table width="100%" height="45"  border="0" cellpadding="1" cellspacing="1" bgcolor="#B7C6DD">
			<tr align="center" valign="middle" bgcolor="#F6F9FE">
				<td height="43" align="center" class="text3">
					<s:form action="medicalorgandbusiness/setpro/getMealList.action" name="query_list_form" id="query_list_form" theme="simple">
						<table width="98%"  border="0" cellpadding="0" cellspacing="0" class="text3">
							<tr>
								<td width="10%" height="41" align="right">套餐名称：</td>
								<td width="10%" align="left">
									<input type="text" name="organSetMealHospital.organSetMeal.packageName" 
									id="itemShowName" value="${organSetMealHospital.organSetMeal.packageName}" class="text3">
								</td>
								
								<td width="10%" height="41" align="right">机构名称：</td>
								<td width="10%" align="left">
									<input type="text" name="organSetMealHospital.hospitalBasicInfo.hospitalLname" 
									value="${organSetMealHospital.hospitalBasicInfo.hospitalLname}" class="text3">
								</td>
					...
					<div class="eXtremeTable">
						<s:if test="#request.list.size>0">
							<com.java.ec:table items="list" var="m" tableId="list" border="0"
								action="${pageContext.request.contextPath}/medicalorgandbusiness/setpro/getMealList.action"
								imagePath="${pageContext.request.contextPath}/product/theme/winxp/resource/js/ectable/images/table/*.gif"
								width="100%" retrieveRowsCallback="limit" sortRowsCallback="limit"
								filterable="false" autoIncludeParameters="true" sortable="false">
								<com.java.ec:row onclick="parent.insertObject('${m.id}','${m.organSetMeal.id}','${m.organSetMeal.packageName}',
										'${m.hospitalBasicInfo.id}','${m.hospitalBasicInfo.hospitalLname}');">
									<com.java.ec:column property="id" alias="id_checkbox" cell="radio" headerCell="checkbox" width="5%"/>
									<com.java.ec:column property="null" title="套餐名称" width="10%">
										${m.organSetMeal.packageName }
									</com.java.ec:column>
									<com.java.ec:column property="null" title="机构名称" width="10%">
										${m.hospitalBasicInfo.hospitalLname }
									</com.java.ec:column>
								</com.java.ec:row>
							</com.java.ec:table>
						</s:if>
