		...
		<table width="90%" border="0" cellspacing="0" cellpadding="0">
			...
			<tr align="center" valign="middle" bgcolor="#F6F9FE">
				<td height="43" align="center" class="text3">
					<s:form action="/doctor/doctorManager/doctorDataGather.action" name="query_list_form" id="query_list_form" theme="simple">
						<table width="98%"  border="0" cellpadding="0" cellspacing="0" class="text3">
							<tr>
								<td width="8%" height="41" align="right">操作人：</td>
								<td width="12%" align="left">
									<input name="organOperator.showName"  type="text" class="input1" 
									value="${organOperator.showName}"/>		
								</td>
								
								<td width="19%" align="left">
									<input type="hidden" name="action" value="getOrganOparatorList">
					...
					<div class="eXtremeTable">
						<s:if test="#request.list.size>0">
							<com.java.ec:table items="list" var="p" tableId="list" border="0"
								action="${pageContext.request.contextPath}/doctor/doctorManager/getOrganOparatorList.action"
								...
								<com.java.ec:row onclick="parent.insertObject('${p.id }','${p.showName }')">
									...
									<com.java.ec:column property="showName" title="操作人" width="10%"/>
								</com.java.ec:row>
							</com.java.ec:table>
						</s:if>
						<s:else>
