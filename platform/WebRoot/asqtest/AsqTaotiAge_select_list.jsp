...
<html>
	...
	<body>
		...
		<table width="100%" height="45"  border="0" cellpadding="1" cellspacing="1" bgcolor="#B7C6DD">
			<tr align="center" valign="middle" bgcolor="#F6F9FE">
				<td height="43" align="center" class="text3">
					<s:form action="/AsqTest/toAsqTaotiAgeSelectPage.action" name="query_list_form" id="query_list_form" theme="simple">
					...
					<div class="eXtremeTable">
						<s:if test="#request.list.size>0">
							<com.java.ec:table items="list" var="p" tableId="list" border="0"
								action="${pageContext.request.contextPath}/AsqTest/toAsqTaotiAgeSelectPage.action"
		...
		<script type="text/javascript">
			$j = jQuery.noConflict();
			var $now_checkedArr = $j("input:radio");
