	...
	<s:actionmessage theme="popwind"/>
		...
		<table width="100%" height="45"  border="0" cellpadding="1" cellspacing="1" bgcolor="#B7C6DD">
			<tr align="center" valign="middle" bgcolor="#F6F9FE">
				<td height="43" align="center" class="text3">
					<s:form action="/AsqTest/getAsqBeenOptionsList.action" name="query_list_form" id="query_list_form" theme="simple">
						<table width="98%"  border="0" cellpadding="0" cellspacing="0" class="text3">
							<tr>
								<td width="8%" height="41" align="right">题目：</td>
								<td width="12%" align="left">
									<input name="asqBeenOptions.asqQuestions.subject"  type="text" class="input1" value="${asqBeenOptions.asqQuestions.subject}"/>		
								</td>
					...
					<div class="eXtremeTable">
						<s:if test="#request.list.size>0">
							<com.java.ec:table items="list" var="p" tableId="list" border="0"
								action="${pageContext.request.contextPath}/AsqTest/getAsqBeenOptionsList.action"
								...
								<com.java.ec:row >
									...
									<com.java.ec:column property="null" title="题目" width="10%">
										${p.asqQuestions.subject }
									</com.java.ec:column>
									<com.java.ec:column property="optionContent" title="选项内容" width="10%"/>
									<com.java.ec:column property="optionCode" title="选项编码" width="10%"/>
									<com.java.ec:column property="isDelete" title="是否删除" width="10%"/>
									<com.java.ec:column property="isNeedRemark" title="是否需要说明" width="10%">
									</com.java.ec:column>
									<com.java.ec:column property="isRightOption" title="是否正确选项" width="10%">
									</com.java.ec:column>
									<com.java.ec:column property="optionScore" title="选项分值" width="10%"/>
								</com.java.ec:row>
							</com.java.ec:table>
						</s:if>
						<s:else>
		...
		<script type="text/javascript">
			...
			function doAdd(action) {
				action="${pageContext.request.contextPath}/AsqTest/toAddOfAsqBeenOptions.action";
			...
			function doEdit(action) {
				...
				window.location.href=action + "?asqBeenOptions.id="+$checked.val();
			}
		</script>
  	</body>
</html>
