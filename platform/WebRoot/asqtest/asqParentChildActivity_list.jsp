	...
	<ap:stepAndOperation></ap:stepAndOperation>
		<table width="100%" height="45"  border="0" cellpadding="1" cellspacing="1" bgcolor="#B7C6DD">
			<tr align="center" valign="middle" bgcolor="#F6F9FE">
				<td height="43" align="center" class="text3">
					<s:form action="/AsqTest/queryAsqParentChildActivityList.action" name="query_list_form" id="query_list_form" theme="simple">
						<table width="98%"  border="0" cellpadding="0" cellspacing="0" class="text3">
								<tr>
								<td width="8%" height="41" align="right">套题：</td>
								<td width="12%" align="left">
									<input name="asqParentChildActivity.taoti.titalName"  type="text" class="input1" value="${asqParentChildActivity.taoti.titalName}"/>		
								</td>
					...
					<div class="eXtremeTable">
						<s:if test="#request.list.size>0">
							<com.java.ec:table items="list" var="p" tableId="list" border="0"
								action="${pageContext.request.contextPath}/AsqTest/queryAsqParentChildActivityList.action"
								...
								<com.java.ec:row >
									...
									<com.java.ec:column property="null" title="套题类型" width="10%">
										${p.taoti.titalName }
									</com.java.ec:column>
									<com.java.ec:column property="applyMinMonthAge" title="最小月龄" width="10%"/>
									<com.java.ec:column property="applyMaxMonthAge" title="最大月龄" width="10%"/>
									<com.java.ec:column property="activityContent" title="活动内容" width="50%"/>
								</com.java.ec:row>
							</com.java.ec:table>
						</s:if>
						<s:else>
		...
		<script type="text/javascript">
			...
			function doEdit(action) {
				...
				window.location.href=action + "?asqParentChildActivity.id="+items;
			}
		</script>
  	</body>
</html>
