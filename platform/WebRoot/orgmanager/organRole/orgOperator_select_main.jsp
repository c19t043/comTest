	...
	<body id="tree_main">
		...
		<script type="text/javascript">
			...
			$j(document).ready(function(){
				...
				var src = "${pageContext.request.contextPath}/orgOperatorManager/orgRoleManager.action?action=toOperatorPage";
			 ...
			 * 查询角色分配的用户
			 */
			function queryRoleOwnedUsers(){
				$j.ajax({
					url:"${pageContext.request.contextPath}/orgOperatorManager/orgRoleManager.action",
					type:"POST",
					async:false,
					data:{"action":"queryRoleOwnedUsers","organRole.id":tID},
			...
			* 保存角色分配的用户
			*/
			function saveRoleOwnedUsers(operatorIDs){
				$j.ajax({
					url:"${pageContext.request.contextPath}/orgOperatorManager/orgRoleManager.action",
					type:"POST",
					async:false,
					data:{"action":"saveRoleOwnedUsers","organRole.id":tID,"operatorIDs":operatorIDs},
					success:function(data){
					},
					error:function(){
