	...
	<s:actionmessage theme="popwind"/>
		...
		<table width="100%" height="45"  border="0" cellpadding="1" cellspacing="1" bgcolor="#B7C6DD">
			<tr align="center" valign="middle" bgcolor="#F6F9FE">
				<td height="43" align="center" class="text3">
					<s:form action="/orgOperatorManager/orgOperatorManager.action" name="query_list_form" id="query_list_form" theme="simple">
						<table width="98%"  border="0" cellpadding="0" cellspacing="0" class="text3">
							<tr>
								...
								<td width="19%" align="left">
									<input name="action"  type="hidden" class="input1" value="queryOrganOperatorByPage"/>
					...
					<div class="eXtremeTable">
						<s:if test="#request.list.size>0">
							<com.java.ec:table items="list" var="p" tableId="list" border="0"
								action="${pageContext.request.contextPath}/orgOperatorManager/orgOperatorManager.action?action=queryOrganOperatorByPage"
		...
		<script type="text/javascript">
			...
			function doAdd(action) {
				action="${pageContext.request.contextPath}/orgOperatorManager/orgOperatorManager.action?action=toAddOrUpdatePage";
			...
			function doEdit(action) {
				...
				window.location.href=action + "&organOperator.id="+$checked.val();
			}
		</script>
  	</body>
</html>
