	...
	<head>
		...
		<script type="text/javascript" src="${pageContext.request.contextPath}/js/rich_text.js"></script>
  		...
  		<script type="text/javascript">
			...
			//返回
			function doBack(){
				window.location.href = "${pageContext.request.contextPath}/orgOperatorManager/organModuleInfoManager.action?action=queryOrganModuleInfoByPage";
			}
  		</script>
  	</head>
  	...
  	<body>
		...
		<form id="form_handle" name="form_handle" action="<s:url namespace="/orgOperatorManager" action="organModuleInfoManager" includeParams="true"/>" method="post" >
			<input name="save" id="save" type="submit" value="save" style="display: none;">
			<input type="hidden" name="action" value="saveOrUpdateOrganModuleInfo">
			<input type="hidden" name="organModuleInfo.id" value="${organModuleInfo.id}">
			<div class="eXtremeTable">
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
					...
					<table width="100%" class="tableRegion2">
						<tr>
							<td width="8%" height="41" align="right">模块名称：<span class="text4">*</span></td>
							<td width="12%" align="left">
								<input type="text" name="organModuleInfo.moduleName" class="validate['required','length[200]'] text3"
								value="${organModuleInfo.moduleName}"/>	
							</td>
							<td width="8%" height="41" align="right">页面路径：<span class="text4">*</span></td>
							<td width="12%" align="left">
								<input type="text" name="organModuleInfo.pagePath" class="validate['required','length[200]'] text3"
								value="${organModuleInfo.pagePath}"/>	
							</td>
					  	</tr>
					  	<tr>
							<td width="8%" height="41" align="right">备注：</td>
							<td width="12%" align="left">
								<input name="organModuleInfo.remark"  type="text" 
								class="validate['length[500]'] text3"  value="${organModuleInfo.remark}"/>		
							</td>
						</tr>
				</table>
			</div>
