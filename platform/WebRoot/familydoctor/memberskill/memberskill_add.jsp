	...
	<head>
		...
		<!--<script type="text/javascript" src="${pageContext.request.contextPath}/platform/theme/public_js/utils2.js"></script>-->
  		...
  		<script type="text/javascript">
			...
			//返回
			function doBack(){
				window.location.href = "${pageContext.request.contextPath}/familydoctor/memberskill/getFdMemberSkillList.action";
			}
			function doSubmit() {
  	...
  	<body>
		...
		<form id="form_handle" name="form_handle" action="<s:url namespace="/familydoctor/memberskill" action="saveOrUpdateFdMemberSkill" includeParams="true"/>" method="post" >
			<input name="save" id="save" type="submit" value="save" style="display: none;">
			<input type="hidden" name="fdMemberSkill.id" value="${fdMemberSkill.id}">
			<div class="eXtremeTable">
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
					...
					<table width="100%" class="tableRegion2">
						<tr>
							<td class="inputLabel">技能名称：</td>
							<td width="30%">
								<input type="text" name="fdMemberSkill.skillName" value="${fdMemberSkill.skillName}" class="validate['required','length[20]'] text3">
								<span class="text4">*</span>
							</td>
					  	</tr>
					  	<tr>
							<td class="inputLabel">技能编码：</td>
							<td width="30%" >
								<input type="text" name="fdMemberSkill.skillCode" value="${fdMemberSkill.skillCode}" class="validate['length[20]'] text3" width="70%">
							</td>
					  	<tr>
							<td width="15%" height="32" align="right" bgcolor="#F6F9FE">备注：</td>
							<td width="85%" height="32" align="left" bgcolor="#F6F9FE" colspan="3">
								<textarea name="fdMemberSkill.remark" class="validate['length[200]'] Added_textarea">${fdMemberSkill.remark}</textarea>
							</td>
					  	</tr>
					</table>
				<br>
