...
<script type="text/javascript">
	...
	window.addEvent('domready', function(){
		...
		var name = environment.dialog.getOpener().$(text).value;
		var id = environment.dialog.getOpener().$(hidden).value;
		...
		$('objectIframe').src = "${pageContext.request.contextPath}/familydoctor/serviceteams/getFdRoleInfoList.action";
	});
