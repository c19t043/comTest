...
// 				window.location.href=action;
				var action = '<s:url namespace="/familydoctor/serviceteams" action="getFdSerivceTeamsList" includeParams="true"/>';
				window.location.href=action + "?teamName.id="+id;
			}
			// 新增信息 
			...
			function doEdit(action) {
				...
				window.location.href=action + "?fdServiceTeams.id="+id;
			}
  		</script>
	</head>
		...
		<table width="100%" height="45"  border="0" cellpadding="1" cellspacing="1" bgcolor="#B7C6DD">
			<tr align="center" valign="middle" bgcolor="#F6F9FE">
				<td height="43" align="center" class="text3">
					<s:form action="/familydoctor/serviceteams/getFdSerivceTeamsList.action" name="query_list_form" id="query_list_form" theme="simple">
						<table width="98%"  border="0" cellpadding="0" cellspacing="0" class="text3">
							<tr>
								<td width="10%" height="41" align="right">显示名称：</td>
								<td width="10%" align="left">
									<input type="text" name="fdServiceTeams.teamName" id="teamName" value="${fdServiceTeams.teamName}" class="text3">
								</td>
					...
					<div class="eXtremeTable">
						<s:if test="#request.list.size>0">
							<com.java.ec:table items="list" var="p" tableId="list" border="0"
								action="${pageContext.request.contextPath}/familydoctor/serviceteams/getFdSerivceTeamsList.action"
								...
								<com.java.ec:row>
									...
									<com.java.ec:column property="teamName" title="团队名称" width="10%"/>
									<com.java.ec:column property="teamCode" title="团队编码" width="10%"/>
