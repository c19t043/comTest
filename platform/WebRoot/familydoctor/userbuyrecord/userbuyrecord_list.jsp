...
// 				window.location.href=action;
				var action = '<s:url namespace="/familydoctor/userBuyRecord" action="getFdUserBuyRecordList" includeParams="true"/>';
				window.location.href=action + "?fdServiceOrder.orderNum.id="+id;
			}
			// 新增信息 
			...
			function doEdit(action) {
				...
				window.location.href=action + "?fdUserBuyRecord.id="+id;
			}
  		</script>
	</head>
		...
		<table width="100%" height="45"  border="0" cellpadding="1" cellspacing="1" bgcolor="#B7C6DD">
			<tr align="center" valign="middle" bgcolor="#F6F9FE">
				<td height="43" align="center" class="text3">
					<s:form action="/familydoctor/userBuyRecord/getFdUserBuyRecordList.action" name="query_list_form" id="query_list_form" theme="simple">
						<table width="98%"  border="0" cellpadding="0" cellspacing="0" class="text3">
							<tr>
								<td width="10%" height="41" align="right">订单号查询：</td>
								<td width="10%" align="left">
									<input type="text" name="fdUserBuyRecord.fdServiceOrder.orderNum" id="fdServiceOrder.orderNum" value="${fdUserBuyRecord.fdServiceOrder.orderNum}" class="text3">
								</td>
					...
					<div class="eXtremeTable">
						<s:if test="#request.list.size>0">
							<com.java.ec:table items="list" var="p" tableId="list" border="0"
								action="${pageContext.request.contextPath}/familydoctor/userBuyRecord/getFdUserBuyRecordList.action"
								...
								<com.java.ec:row>
									...
									<com.java.ec:column property="fdUserBuyRecord.fdServiceOrder.orderNum" title="订单号" width="10%">
										${p.fdServiceOrder.orderNum}
									</com.java.ec:column>
									<com.java.ec:column property="serviceStartTime" title="服务开始时间" width="10%"/>
 									<com.java.ec:column property="serviceEndTime" title="服务结束时间" width="10%"/>
 									<com.java.ec:column property="payPrice" title="订单金额" width="10%"/> 
								</com.java.ec:row>
							</com.java.ec:table>
						</s:if>
						<s:else>
