		...
		<table width="100%" height="45"  border="0" cellpadding="1" cellspacing="1" bgcolor="#B7C6DD">
			<tr align="center" valign="middle" bgcolor="#F6F9FE">
				<td height="43" align="center" class="text3">
					<form action="${pageContext.request.contextPath}/familydoctor/serviceItems/getFdServiceItemsList.action" name="query_list_form" id="query_list_form" theme="simple">
						<table width="98%"  border="0" cellpadding="0" cellspacing="0" class="text3">
							<tr>
								<td height="41" align="right">显示名称：</td>
								<td align="left">
									<input type="text" name="fdServiceItems.itemShowName" id="itemShowName" value="${fdServiceItems.itemShowName}" class="text3">
								</td>
								<td align="left">
				...
				<td>
					<div class="eXtremeTable">
						...
						<com.java.ec:table items="list" var="m" tableId="list" border="0"
								action="${pageContext.request.contextPath}/familydoctor/servicePackage/toJumpFdServiceItems.action"
								imagePath="${pageContext.request.contextPath}/product/theme/winxp/resource/js/ectable/images/table/*.gif"
								width="100%" retrieveRowsCallback="limit" sortRowsCallback="limit"
								filterable="false" autoIncludeParameters="true" sortable="false">
								<com.java.ec:row onclick="parent.insertObject('${m.id}','${m.itemShowName}');">
									<com.java.ec:column property="id" alias="id_checkbox" cell="checkbox" headerCell="checkbox" width="5%"/>
									<com.java.ec:column property="itemShowName" title="显示名称" width="10%"/>
									<com.java.ec:column property="url" title="页面url" width="10%"/>
									<com.java.ec:column property="imagePath" title="图片路径" width="10%"/>
									<com.java.ec:column property="null" title="创建日期" width="10%">
