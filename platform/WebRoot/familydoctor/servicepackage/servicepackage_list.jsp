...
// 				window.location.href=action;
				var action = '<s:url namespace="/familydoctor/servicePackage" action="getFdServicePackageList" includeParams="true"/>';
				window.location.href=action + "?packageShowName.id="+id;
			}
			// 新增信息 
			...
			function doEdit(action) {
				...
				window.location.href=action + "?fdServicePackage.id="+id;
			}
  		</script>
	</head>
		...
		<table width="100%" height="45"  border="0" cellpadding="1" cellspacing="1" bgcolor="#B7C6DD">
			<tr align="center" valign="middle" bgcolor="#F6F9FE">
				<td height="43" align="center" class="text3">
					<s:form action="/familydoctor/servicePackage/getFdServicePackageList.action" name="query_list_form" id="query_list_form" theme="simple">
						<table width="98%"  border="0" cellpadding="0" cellspacing="0" class="text3">
							<tr>
								<td width="10%" height="41" align="right">显示名称：</td>
								<td width="10%" align="left">
									<input type="text" name="fdServicePackage.packageShowName" id="packageShowName" value="${fdServicePackage.packageShowName}" class="text3">
								</td>
					...
					<div class="eXtremeTable">
						<s:if test="#request.list.size>0">
							<com.java.ec:table items="list" var="p" tableId="list" border="0"
								action="${pageContext.request.contextPath}/familydoctor/servicePackage/getFdServicePackageList.action"
								...
								<com.java.ec:row>
									...
									<com.java.ec:column property="packageShowName" title="服务包显示名称" width="10%"/>
									<com.java.ec:column property="packageCode" title="服务包编码" width="10%"/>
									<com.java.ec:column property="null" title="归属医疗机构" width="10%">
										${p.hospitalBasicInfo.hospitalLname }
									</com.java.ec:column>
									<com.java.ec:column property="isOfflinePay" title=" 是否可线下支付" width="10%"/>
									<com.java.ec:column property="serviceItemIds" title="服务项目组合" width="10%"/>
