		...
		<table width="100%" height="45"  border="0" cellpadding="1" cellspacing="1" bgcolor="#B7C6DD">
			<tr align="center" valign="middle" bgcolor="#F6F9FE">
				<td height="43" align="center" class="text3">
					<form action="${pageContext.request.contextPath}/familydoctor/servicePackage/getHospitalInfoList.action" name="query_list_form" id="query_list_form" theme="simple">
						<table width="98%"  border="0" cellpadding="0" cellspacing="0" class="text3">
							<tr>
								<td width="8%" height="41" align="right">医院名称：</td>
								<td width="12%" align="left">
									<input type="text" name="hospitalBasicInfo.hospitalLname" id="hospitalBasicInfo.hospitalLname" value="${hospitalBasicInfo.hospitalLname}" class="text3">
								</td>
				...
				<td>
					<div class="eXtremeTable">
						<s:if test="#request.list.size>0">
							<com.java.ec:table items="list" var="t" tableId="list" border="0"
								action="${pageContext.request.contextPath}/familydoctor/archivesInfo/getUserTypeList.action"
								imagePath="${pageContext.request.contextPath}/product/theme/winxp/resource/js/ectable/images/table/*.gif"
								width="100%" retrieveRowsCallback="limit" sortRowsCallback="limit"
								filterable="false" autoIncludeParameters="true" sortable="false">
								<com.java.ec:row onclick="parent.insertObject('${t.id}','${t.typeName}');">
									<com.java.ec:column property="typeName" alias="tableInfoId_radio" cell="radio" title="选择"  width="10%" />
									<com.java.ec:column property="typeName" title="类型名称" width="30%"/>
									<com.java.ec:column property="typeCode" title="类型代码" width="30%"/>
									<com.java.ec:column property="remark" title="说明" width="30%"/>
									<com.java.ec:column property="isEnable" title="是否可用Y/N" width="30%"/>
								</com.java.ec:row>
							</com.java.ec:table>
						</s:if>
						<s:else>
