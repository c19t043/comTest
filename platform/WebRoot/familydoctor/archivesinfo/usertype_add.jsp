	...
	<head>
		...
		<!--<script type="text/javascript" src="${pageContext.request.contextPath}/platform/theme/public_js/utils2.js"></script>-->
  		...
  		<script type="text/javascript">
			...
			//返回
			function doBack(){
				window.location.href = "${pageContext.request.contextPath}/familydoctor/usertype/getUserTypeList.action";
			}
  	...
  	<body>
		...
		<form id="form_handle" name="form_handle" action="<s:url namespace="/familydoctor/usertype" action="saveOrUpdateUserType" includeParams="true"/>" method="post" >
			...
			<div class="eXtremeTable">
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
					...
					<table width="100%" class="tableRegion2">
						<tr>
							<td class="inputLabel">类型名称：</td>
							<td width="30%">
								<input type="text" name="userType.typeName" value="${userType.typeName}" class="validate['required','length[20]'] text3">
								<span class="text4">*</span>
							</td>
							
							<td class="inputLabel">类型代码：</td>
							<td width="30%" >
								<input type="text" name="userType.typeCode" value="${userType.typeCode}" class="validate['length[20]'] text3" width="70%">
							</td>
					  	</tr>
					  	<tr>
							...
							<td width="30%">
								<s:select cssStyle="width:100px;" cssClass="text3" list="#{'Y':'可用','N':'不可用'}" listKey="key" listValue="value" 
									theme="simple" name="userType.isEnable" value="userType.isEnable"/>
								<span class="text4">*</span>
							</td> 	
					  	</tr>
					  	<tr>
							<td width="15%" height="32" align="right" bgcolor="#F6F9FE">说明：</td>
							<td width="85%" height="32" align="left" bgcolor="#F6F9FE" colspan="3">
								<textarea name="userType.remark" class="validate['length[200]'] Added_textarea">${userType.remark}</textarea>
							</td>
					  	</tr>
