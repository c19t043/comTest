...
// 				window.location.href=action;
				...
				window.location.href=action + "?fdServiceMember.id="+id;
			}
			// 编辑信息 
		...
		<table width="100%" height="45"  border="0" cellpadding="1" cellspacing="1" bgcolor="#B7C6DD">
			<tr align="center" valign="middle" bgcolor="#F6F9FE">
				<td height="43" align="center" class="text3">
					<s:form action="/familydoctor/teamRole/getFdServiceMemberList.action" name="query_list_form" id="query_list_form" theme="simple">
						<table width="98%"  border="0" cellpadding="0" cellspacing="0" class="text3">
							<tr>
								<td width="10%" height="41" align="right">成员名称：</td>
					...
					<div class="eXtremeTable">
						<s:if test="#request.list.size>0">
							<com.java.ec:table items="list" var="p" tableId="list" border="0"
								action="${pageContext.request.contextPath}/familydoctor/teamRole/getFdServiceMemberList.action"
								...
								<com.java.ec:row>
									...
									<com.java.ec:column property="null" title="归属团队" width="10%">
										${p.fdServiceTeams.teamName }
									</com.java.ec:column>
									<com.java.ec:column property="null" title="团队编码" width="10%">
										${p.fdServiceTeams.teamCode }
									</com.java.ec:column>
									<com.java.ec:column property="null" title="团队备注" width="10%">
										${p.fdServiceTeams.remark }
									</com.java.ec:column>
									<com.java.ec:column property="null" title="成员名称" width="10%">
										${p.doctorInfo.doctorName }
									</com.java.ec:column>
									<com.java.ec:column property="null" title="角色名称" width="10%">
										${p.fdRoleInfo.roleName }
									</com.java.ec:column>
									<com.java.ec:column property="skilNames" title="技能" width="10%"/>
								</com.java.ec:row>
							</com.java.ec:table>
						</s:if>
						<s:else>
