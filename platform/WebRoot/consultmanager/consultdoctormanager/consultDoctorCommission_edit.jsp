...
<html>
	<head>
  	...
  	<body>
		...
		<form id="form_handle" name="form_handle" action="<s:url namespace="/consultmanager/consultdoctormanager" action="update" includeParams="true"/>" method="post" >
			<input name="save" id="save" type="submit" value="save" style="display: none;">
			<input type="hidden" name="commission.position.id" value="${commissioninfos.position.id}">
			<input type="hidden" name="commission.id" value="${commissioninfos.id}">
				...
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
					...
					<table width="100%" class="tableRegion2">
						<tr>
							...
							<td width="30%" >
								<input type="text" name="commission.position.name" disabled="disabled" value="${commissioninfos.position.name}" class="validate['length[20]'] text3" width="70%">
							</td>
							
							<td class="inputLabel">咨询费：</td>
							<td width="30%" >
								<input type="text" name="commission.consultMoney" value="${commissioninfos.consultMoney}" class="validate['length[20]'] text3" width="70%">
							</td>
					  	</tr>
					  	<tr>
							<td class="inputLabel">分成比例：</td>
							<td width="30%" >
								<input type="text" name="commission.consultCommission" value="${commissioninfos.consultCommission}" class="validate['length[20]'] text3" width="70%">
							</td>
