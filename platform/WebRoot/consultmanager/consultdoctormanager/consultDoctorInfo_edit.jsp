	...
	<head>
		...
		<!--<script type="text/javascript" src="${pageContext.request.contextPath}/platform/theme/public_js/utils2.js"></script>-->
  		...
  		<script type="text/javascript">
			...
			//返回
			function doBack(){
				window.location.href = "${pageContext.request.contextPath}/consultmanager/consultdoctormanager/toDoctorList.action";
			}
  	...
  	<body>
		...
		<form id="form_handle" name="form_handle" action="<s:url namespace="/consultmanager/consultdoctormanager" action="doctorSaveOrUpdate" includeParams="true"/>" method="post" >
			<input name="save" id="save" type="submit" value="save" style="display: none;">
			<input type="hidden" name="consultDoctorInfo.doctorInfo.id" value="${consultDoctorInfos.doctorInfo.id}">
			<input type="hidden" name="consultDoctorInfo.id" value="${consultDoctorInfos.id}">
			<div class="eXtremeTable">
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
					...
					<table width="100%" class="tableRegion2">
						<tr>
							<td class="inputLabel">医生姓名：</td>
							<td width="30%" >
								<input type="text" name="consultDoctorInfo.doctorInfo.doctorName" disabled="disabled" value="${consultDoctorInfos.doctorInfo.doctorName}" class="validate['length[20]'] text3" width="70%">
							</td>
							
							<td class="inputLabel">服务时长（小时为单位）：</td>
							<td width="30%" >
								<input type="text" name="consultDoctorInfo.serviceLength" value="${consultDoctorInfos.serviceLength }" class="validate['length[20]'] text3" width="70%">
							</td>
					  	</tr>
					  	<tr>
							<td class="inputLabel">职称：</td>
							<td width="30%" >
								<input type="text" name="consultDoctorInfo.doctorInfo.doctorTitle" disabled="disabled" value="${consultDoctorInfos.doctorInfo.doctorTitle}" class="validate['length[20]'] text3" width="70%">
							</td>
							
							<td class="inputLabel">咨询费:</td>
							<td width="30%" >
								<input type="text" name="consultDoctorInfo.consultMoney" value="${consultDoctorInfos.consultMoney}" class="validate['length[20]'] text3" width="70%">
							</td>
					  	</tr>
					  	<tr>
							<td class="inputLabel">分成比例：</td>
							<td width="30%" >
								<input type="text" name="consultDoctorInfo.consultCommission" value="${consultDoctorInfos.consultCommission}" class="validate['length[20]'] text3" width="70%">
							</td>
							
							<td class="inputLabel">是否使用 Y：是 N：否</td>
							<td width="30%">
								<s:select cssStyle="width:100px;" cssClass="text3" list="#{'Y':'Y','N':'N'}" listKey="key" listValue="value" 
									theme="simple" name="consultDoctorInfo.isEnable"
									/>
								<span class="text4">*</span>
							</td> 
					  	</tr>
					  	<tr>
							<td class="inputLabel">是否推荐 Y：是 N：否</td>
							<td width="30%">
								<s:select cssStyle="width:100px;" cssClass="text3" list="#{'Y':'Y','N':'N'}" listKey="key" listValue="value" 
									theme="simple" name="consultDoctorInfo.isRecommend" />
								<span class="text4">*</span>
							</td> 	
					  	</tr>
					  	<tr>
							<td class="inputLabel">推荐奖励:</td>
							<td width="30%" >
								<input type="text" name="consultDoctorInfo.recommendMoney"  value="${consultDoctorInfo.recommendMoney }" class="validate['length[20]'] text3" width="70%">
							</td>
					  	</tr>
					</table>
				<br>
