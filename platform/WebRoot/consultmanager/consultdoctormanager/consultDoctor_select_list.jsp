		...
		<table width="100%" height="45"  border="0" cellpadding="1" cellspacing="1" bgcolor="#B7C6DD">
			<tr align="center" valign="middle" bgcolor="#F6F9FE">
				<td height="43" align="center" class="text3">
					<s:form action="/consultmanager/consultdoctormanager/getDoctorInfoList.action" name="query_list_form" id="query_list_form" theme="simple">
						<table width="98%"  border="0" cellpadding="0" cellspacing="0" class="text3">
							<tr>
								<td width="10%" height="41" align="right">医生名称：</td>
								<td width="10%" align="left">
									<input type="text" name="doctorInfo.doctorName" id="itemShowName" value="${doctorInfo.doctorName}" class="text3">
				...
				<td>
					<div class="eXtremeTable">
						...
						<com.java.ec:table items="list" var="m" tableId="list" border="0"
								action="${pageContext.request.contextPath}/consultmanager/consultdoctormanager/getDoctorInfoList.action"
								imagePath="${pageContext.request.contextPath}/product/theme/winxp/resource/js/ectable/images/table/*.gif"
								width="100%" retrieveRowsCallback="limit" sortRowsCallback="limit"
								filterable="false" autoIncludeParameters="true" sortable="false">
								<com.java.ec:row onclick="parent.insertObject('${m.id}','${m.doctorName}');">
									...
									<com.java.ec:column property="null" title="医生职称" width="10%">
										${m.doctorTitle }
									</com.java.ec:column>
									<com.java.ec:column property="null" title="工作单位" width="10%">
										${m.doctorEmployer }
									</com.java.ec:column>
								</com.java.ec:row>
							</com.java.ec:table>
