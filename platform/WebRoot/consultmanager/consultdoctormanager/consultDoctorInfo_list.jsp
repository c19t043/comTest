		...
		<table width="100%" height="45"  border="0" cellpadding="1" cellspacing="1" bgcolor="#B7C6DD">
			<tr align="center" valign="middle" bgcolor="#F6F9FE">
				<td height="43" align="center" class="text3">
					<s:form action="/consultmanager/consultdoctormanager/toDoctorList.action" name="query_list_form" id="query_list_form" theme="simple">
						<table width="98%"  border="0" cellpadding="0" cellspacing="0" class="text3">
							<tr>
								<td width="10%" height="41" align="right">医生名字：</td>
								<td width="10%" align="left">
									<input type="text" name="consultDoctorInfo.doctorInfo.doctorName" id="roleName" value="" class="text3">
								</td>
					...
					<div class="eXtremeTable">
						<s:if test="#request.list.size>0">
							<com.java.ec:table items="list" var="p" tableId="list" border="0"
								action="${pageContext.request.contextPath}/consultmanager/consultdoctormanager/toDoctorList.action"
								...
								<com.java.ec:row>
									...
									<com.java.ec:column property="doctorInfo.doctorTitle" title="职称" width="10%"/>
									<com.java.ec:column property="serviceLength" title="服务时长（小时为单位）" width="10%"/>
									<com.java.ec:column property="consultMoney" title="咨询费" width="10%"/>
									<com.java.ec:column property="recommendMoney" title="推荐奖励" width="10%"/>
									...
									<com.java.ec:column property="isRecommend" title="是否推荐（Y/N）" width="10%"/>
								</com.java.ec:row>
							</com.java.ec:table>
						</s:if>
						<s:else>
