	...
	<head>
		...
		<!--<script type="text/javascript" src="${pageContext.request.contextPath}/platform/theme/public_js/utils2.js"></script>-->
  		...
  		<script type="text/javascript">
			...
			//返回
			function doBack(){
				window.location.href = "${pageContext.request.contextPath}/consultmanager/consultdoctormanager/list.action";
			}
  	...
  	<body>
		...
		<form id="form_handle" name="form_handle" action="<s:url namespace="/consultmanager/consultdoctormanager" action="addConsultDoctorCommission" includeParams="true"/>" method="post" >
			<input name="save" id="save" type="submit" value="save" style="display: none;">
			<input type="hidden" name="commission.positionId" value="${commission.position.id}">
			<input type="hidden" name="commission.id" value="${commission.id }">
			<input type="hidden" name="commission.isEnableOld" value="${commission.isEnable}">
			<div class="eXtremeTable">
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
					...
					<table width="100%" class="tableRegion2">
						<tr>
						<td class="inputLabel">职称名字</td>
							<td width="30%">
								<s:select cssStyle="width:100px;" cssClass="text3" list="#positionInfo" listKey="id" listValue="name" 
									theme="simple" name="commission.position.id" value="name"
									/>
							...
							<td width="30%" >
								<input type="text" name="commission.consultMoney" value="${commission.consultMoney}" class="validate['length[20]'] text3" width="70%">
							</td>
					  	</tr>
					  	<tr>
							<td class="inputLabel">分成比例：</td>
							<td width="30%" >
								<input type="text" name="commission.consultCommission" value="${commission.consultCommission}" class="validate['length[20]'] text3" width="70%">
							</td>
							
							<td class="inputLabel">是否试用 Y：是 N：否</td>
							<td width="30%">
								<s:select cssStyle="width:100px;" cssClass="text3" list="#{'Y':'Y','N':'N'}" listKey="key" listValue="value" 
									theme="simple" name="commission.isEnable" value="commission.isEnable"
									/>
								<span class="text4">*</span>
							</td> 	
					  	</tr>
