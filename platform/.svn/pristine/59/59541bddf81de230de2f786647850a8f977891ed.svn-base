			...
			<div class="wz_right">
				<div class="but01">
					<div class="pop_button_bar">
						<span><a href="javascript:doSend();" class="pop_button_blue">发送</a></span>
					</div>
				</div>
			</div>
		</div>
		...
		<table width="100%" height="45"  border="0" cellpadding="1" cellspacing="1" bgcolor="#B7C6DD">
			<tr align="center" valign="middle" bgcolor="#F6F9FE">
				<td height="43" align="center" class="text3">
					<s:form action="/AsqTest/getAsqResultScoreExList.action" name="query_list_form" id="query_list_form" theme="simple">
						<table width="98%"  border="0" cellpadding="0" cellspacing="0" class="text3">
							<tr>
								<td width="8%" height="41" align="right">问卷显示名称：</td>
								<td width="12%" align="left">
									<input name="asqResultScoreExUser.asqTaotiAge.showName"  type="text" class="input1" 
									value="${asqResultScoreExUser.asqTaotiAge.showName}"/>		
								</td>
<%-- 								<td width="8%" height="41" align="right">套题名称：</td>
								<td width="12%" align="left">
									<input name="asqResultScoreEx.asqTaoti.parent.titalName"  type="text" class="input1" 
									value="${asqResultScoreEx.asqTaoti.parent.titalName}"/>		
								</td> --%>
								
<%-- 								<td width="8%" height="41" align="right">题目：</td>
								<td width="12%" align="left">
									<input name="asqResultScoreEx.asqTaoti.titalName"  type="text" class="input1" 
									value="${asqResultScoreEx.asqTaoti.titalName}"/>		
								</td> --%>
								
								<td width="8%" height="41" align="right">答题人电话：</td>
								<td width="12%" align="left">
									<input name="asqResultScoreExUser.userInfo.phone"  type="text" class="input1" 
									value="${asqResultScoreExUser.userInfo.phone}"/>		
								</td>
								
								<td width="8%" height="41" align="right">状态：</td>
								<td width="12%" align="left">
									<s:select list="#{'待审阅':'待审阅','已审阅':'已审阅','已发送':'已发送'}"
									headerKey="" headerValue=""
									listKey="key" listValue="value"
									name="asqResultScoreExUser.status" value="asqResultScoreExUser.status"
									></s:select>	
								</td>
					...
					<div class="eXtremeTable">
						<s:if test="#request.list.size>0">
							<com.java.ec:table items="list" var="p" tableId="list" border="0"
								action="${pageContext.request.contextPath}/AsqTest/getAsqResultScoreExList.action"
								...
								<com.java.ec:row >
									...
									<com.java.ec:column property="null" title="适用月龄" width="10%">
										${p.asqTaotiAge.applyMinMonthAge }-${p.asqTaotiAge.applyMaxMonthAge }
									</com.java.ec:column>
<%-- 									<com.java.ec:column property="showName" title="题目" width="10%">
										${p.asqTaoti.titalName }
									</com.java.ec:column> --%>
									<com.java.ec:column property="null" title="答题人电话" width="10%">
										${p.userInfo.phone }
									</com.java.ec:column>
									<com.java.ec:column property="null" title="答题人" width="10%">
										${p.userInfo.parentName }
									</com.java.ec:column>
									<com.java.ec:column property="null" title="宝宝姓名" width="10%">
										${p.asqTestUserInfo.asqUserName }
									</com.java.ec:column>
									<com.java.ec:column property="status" title="状态" width="10%"  />
									<com.java.ec:column property="null" title="操作" width="10%">
										<a href="javascript:void();" onclick="doDetail('${p.id}')">详情</a>
									</com.java.ec:column>
								</com.java.ec:row>
							</com.java.ec:table>
						</s:if>
		...
		<script type="text/javascript">
			...
			function doDetail(id) {
				action="${pageContext.request.contextPath}/AsqTest/toAddOfAsqResultScoreEx.action?asqResultScoreExUser.id="+id;
			...
			function doSend(){
				...
				var statu = $checked.parent().parent().find("td:last").prev().html();
				if('已审阅'!=statu){
					alert("只能发送'已审阅'状态的测评结果");return;
				}
				if(!confirm('确定要发送吗？')) return;
				var id = $checked.val();
				action="${pageContext.request.contextPath}/AsqTest/saveOrUpdateAsqResultScoreEx.action?asqResultScoreEx.id="+id;
				window.location.href=action;
			}
		</script>
  	</body>
