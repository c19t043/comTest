...
public class DoctorMoneyRecord implements java.io.Serializable {
	...
	public DoctorMoneyRecord(){}
	public DoctorMoneyRecord(HospitalPosition hospitalPosition,DoctorInfo doctorInfo
			,String workDate,String workStartTime,String workEndTime){
