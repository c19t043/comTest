...
// 				window.location.href=action;
				var action = '<s:url namespace="/familydoctor/servicetimes" action="getFdServiceTimesList" includeParams="true"/>';
				window.location.href=action + "?timeName.id="+id;
			}
			// 新增信息 
			...
			function doEdit(action) {
				...
				window.location.href=action + "?fdServiceTimes.id="+id;
			}
  		</script>
	</head>
		...
		<table width="100%" height="45"  border="0" cellpadding="1" cellspacing="1" bgcolor="#B7C6DD">
			<tr align="center" valign="middle" bgcolor="#F6F9FE">
				<td height="43" align="center" class="text3">
					<s:form action="/familydoctor/servicetimes/getFdServiceTimesList.action" name="query_list_form" id="query_list_form" theme="simple">
						<table width="98%"  border="0" cellpadding="0" cellspacing="0" class="text3">
							<tr>
								<td width="10%" height="41" align="right">显示名称：</td>
								<td width="10%" align="left">
									<input type="text" name="fdServiceTimes.timeName" id="timeName" value="${fdServiceTimes.timeName}" class="text3">
								</td>
					...
					<div class="eXtremeTable">
						<s:if test="#request.list.size>0">
							<com.java.ec:table items="list" var="p" tableId="list" border="0"
								action="${pageContext.request.contextPath}/familydoctor/servicetimes/getFdServiceTimesList.action"
								...
								<com.java.ec:row>
									...
									<com.java.ec:column property="timeName" title="时间名称" width="10%"/>
 									<com.java.ec:column property="effectiveTime" title="有效时长（天）" width="10%"/>
 									<com.java.ec:column property="effectiveTimeShow" title="有效时长显示" width="10%"/>
 									<com.java.ec:column property="servicePrice" title="服务价格" width="10%"/> 
 									<com.java.ec:column property="isRecommend" title="是否推荐" width="10%"/> 
