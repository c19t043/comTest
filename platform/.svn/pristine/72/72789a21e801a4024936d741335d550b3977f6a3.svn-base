		...
		<table width="100%" height="45"  border="0" cellpadding="1" cellspacing="1" bgcolor="#B7C6DD">
			<tr align="center" valign="middle" bgcolor="#F6F9FE">
				<td height="43" align="center" class="text3">
					<s:form action="b2cGoods/goodsDeliverManager/getDeliverInfoList.action" name="query_list_form" id="query_list_form" theme="simple">
					...
					<div class="eXtremeTable">
						<s:if test="#request.list.size>0">
							<com.java.ec:table items="list" var="o" tableId="list" border="0"
								action="${pageContext.request.contextPath}/b2cGoods/goodsDeliverManager/getDeliverInfoList.action"
								...
								<com.java.ec:row>
									...
									<com.java.ec:column property="dname" title="名称" width="5%"/>
									<com.java.ec:column property="dmoney" title="价格" width="5%"/>
									<com.java.ec:column property="null" title="是否默认" width="5%">
										${o.isMain=='Y' ? '是' : '否'}
									</com.java.ec:column>
...
<script type="text/javascript">
	...
	function doEdit(action) {
		...
		window.location.href=action + "?b2cGoodsDeliver.id="+items;
	}
</script>