...
<script type="text/javascript">
	...
	window.addEvent('domready', function(){
		...
		var serviceItemIds = environment.dialog.getOpener().$(hidden).value;
		...
		$('objectIframe').src = "${pageContext.request.contextPath}/familydoctor/servicePackage/toJumpFdServiceItems.action";
	});
