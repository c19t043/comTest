	...
	<s:actionmessage theme="popwind"/>
		...
		<table width="100%" height="45"  border="0" cellpadding="1" cellspacing="1" bgcolor="#B7C6DD">
			<tr align="center" valign="middle" bgcolor="#F6F9FE">
				<td height="43" align="center" class="text3">
					<s:form action="/AsqTest/getAsqTaotisList.action" name="query_list_form" id="query_list_form" theme="simple">
						<table width="98%"  border="0" cellpadding="0" cellspacing="0" class="text3">
							<tr>
								<td width="8%" height="41" align="right">标题：</td>
								<td width="12%" align="left">
									<input name="asqTaoti.titalName"  type="text" class="input1" value="${asqTaoti.titalName}"/>		
								</td>
								
								<td width="8%" height="41" align="right">父标题：</td>
								<td width="12%" align="left">
									<input name="asqTaoti.parent.titalName"  type="text" class="input1" value="${asqTaoti.parent.titalName}"/>		
								</td>
					...
					<div class="eXtremeTable">
						<s:if test="#request.list.size>0">
							<com.java.ec:table items="list" var="p" tableId="list" border="0"
								action="${pageContext.request.contextPath}/AsqTest/getAsqTaotisList.action"
								...
								<com.java.ec:row >
									...
									<com.java.ec:column property="titalName" title="标题" width="10%"/>
									<com.java.ec:column property="null" title="父标题" width="10%">
										${p.parent.titalName }
									</com.java.ec:column>
		...
		<script type="text/javascript">
			...
			function doAdd(action) {
				action="${pageContext.request.contextPath}/AsqTest/toAddOfAsqTaoti.action";
			...
			function doEdit(action) {
				...
				window.location.href=action + "?asqTaoti.id="+$checked.val();
			}
		</script>
  	</body>
</html>
