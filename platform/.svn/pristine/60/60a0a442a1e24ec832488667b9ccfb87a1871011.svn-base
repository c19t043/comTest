...
// 				window.location.href=action;
				...
				window.location.href=action + "?userType.id="+id;
			}
			// 新增信息 
		...
		<table width="100%" height="45"  border="0" cellpadding="1" cellspacing="1" bgcolor="#B7C6DD">
			<tr align="center" valign="middle" bgcolor="#F6F9FE">
				<td height="43" align="center" class="text3">
					<s:form action="/familydoctor/usertype/getUserTypeList.action" name="query_list_form" id="query_list_form" theme="simple">
						<table width="98%"  border="0" cellpadding="0" cellspacing="0" class="text3">
							<tr>
								<td width="10%" height="41" align="right">类型名称查询：</td>
								<td width="10%" align="left">
									<input type="text" name="userType.typeName" id="typeName" value="${userType.typeName}" class="text3">
								</td>
					...
					<div class="eXtremeTable">
						<s:if test="#request.list.size>0">
							<com.java.ec:table items="list" var="p" tableId="list" border="0"
								action="${pageContext.request.contextPath}/familydoctor/usertype/getUserTypeList.action"
								...
								<com.java.ec:row>
									...
									<com.java.ec:column property="typeName" title="类型名称" width="10%"/>
									<com.java.ec:column property="typeCode" title="类型代码" width="10%"/>
									<com.java.ec:column property="remark" title="说明" width="10%"/>
