	...
	<s:actionmessage theme="popwind"/>
		...
		<table width="100%" height="45"  border="0" cellpadding="1" cellspacing="1" bgcolor="#B7C6DD">
			<tr align="center" valign="middle" bgcolor="#F6F9FE">
				<td height="43" align="center" class="text3">
					<s:form action="/AsqTest/getAsqTaotiAgesList.action" name="query_list_form" id="query_list_form" theme="simple">
						<table width="98%"  border="0" cellpadding="0" cellspacing="0" class="text3">
							<tr>
								<td width="8%" height="41" align="right">显示名字：</td>
								<td width="12%" align="left">
									<input name="asqTaotiAge.showName"  type="text" class="input1" value="${asqTaotiAge.showName}"/>		
								</td>
								<td width="8%" height="41" align="right">关联套题：</td>
								<td width="12%" align="left">
									<input name="asqTaotiAge.taoti.titalName"  type="text" class="input1" value="${asqTaotiAge.taoti.titalName}"/>		
								</td>
					...
					<div class="eXtremeTable">
						<s:if test="#request.list.size>0">
							<com.java.ec:table items="list" var="p" tableId="list" border="0"
								action="${pageContext.request.contextPath}/AsqTest/getAsqTaotiAgesList.action"
								...
								<com.java.ec:row >
									...
									<com.java.ec:column property="showName" title="显示名字" width="10%"/>
									<com.java.ec:column property="null" title="关联套题" width="10%">
										${p.taoti.titalName }
									</com.java.ec:column>
									<com.java.ec:column property="null" title="适用月龄" width="10%">
										${p.applyMinMonthAge }月-${p.applyMaxMonthAge }月
									</com.java.ec:column>
								</com.java.ec:row>
							</com.java.ec:table>
						</s:if>
		...
		<script type="text/javascript">
			...
			function doAdd(action) {
				action="${pageContext.request.contextPath}/AsqTest/toAddOfAsqTaotiAge.action";
			...
			function doEdit(action) {
				...
				window.location.href=action + "?asqTaotiAge.id="+$checked.val();
			}
		</script>
  	</body>
</html>
