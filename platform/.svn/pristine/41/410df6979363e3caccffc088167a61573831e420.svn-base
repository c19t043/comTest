...
// 				window.location.href=action;
			...
			function doEdit(action) {
				...
				window.location.href=action + "?fdServiceItems.id="+id;
			}
  		</script>
	</head>
		...
		<table width="100%" height="45"  border="0" cellpadding="1" cellspacing="1" bgcolor="#B7C6DD">
			<tr align="center" valign="middle" bgcolor="#F6F9FE">
				<td height="43" align="center" class="text3">
					<s:form action="/familydoctor/serviceItems/getFdServiceItemsList.action" name="query_list_form" id="query_list_form" theme="simple">
