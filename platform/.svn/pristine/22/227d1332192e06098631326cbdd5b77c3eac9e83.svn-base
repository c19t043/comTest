					...
					<div class="eXtremeTable">
						<s:if test="#request.list.size>0">
							<com.java.ec:table items="list" var="p" tableId="list" border="0"
								action="${pageContext.request.contextPath}/productionvisit/moreFollow/toPhPrenatalFollowRecordAfterList.action?accountId=${p.familyAccountInfo.id}"
