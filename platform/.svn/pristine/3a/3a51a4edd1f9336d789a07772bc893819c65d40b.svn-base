...
<html>
	<head> 
  	...
  	<body>
		...
		<form id="form_add" class="form" action='<s:url namespace="/operationmanage" action="addingOpenClinicInfo" includeParams="true"/>' method="post">
			...
			<table width="100%" border="0" cellpadding="1" cellspacing="1" bgcolor="#B7C6DD">
				<tr align="center" valign="middle" class="text3">
					...
					<td width="35%" height="32" align="left" bgcolor="#F6F9FE">
						&nbsp;&nbsp;
						<input name="openClinicInfo.openClinicDate" id="openClinicInfo.openClinicDate" type="text" class="input1 Wdate validate['required']" onFocus="WdatePicker({isShowClear:false,readOnly:true});"/>
					</td>
				...
				<tr align="center" valign="middle" class="text3">
					...
					<td width="35%" height="32" align="left" bgcolor="#F6F9FE">
						&nbsp;&nbsp;
						<input type="checkbox" onclick="doCheckedAm(this);" name="openClinicInfo.timeSlot" value="上午" checked="checked">上午&nbsp;&nbsp;<input type="checkbox" onclick="doCheckedPm(this);" name="openClinicInfo.timeSlot" value="下午" checked="checked">下午
					</td>
				...
				<tr align="center" valign="middle" class="text3">
					...
					<td width="35%" height="32" align="left" bgcolor="#F6F9FE">
						&nbsp;&nbsp;
						<input name="openClinicInfo.planStartTime" id="openClinicInfo.planStartTime" type="text" class="input1 Wdate validate[]" onFocus="WdatePicker({isShowClear:false,readOnly:true});"/>
					</td>
					<td width="15%" height="32" align="right" bgcolor="#F6F9FE">计划结束时间<span class="text4"></span>：</td>
					<td width="35%" height="32" align="left" bgcolor="#F6F9FE">
						&nbsp;&nbsp;
						<input name="openClinicInfo.planEndTime" id="openClinicInfo.planEndTime" type="text" class="input1 Wdate validate[]" onFocus="WdatePicker({isShowClear:false,readOnly:true});"/>
					</td>
				</tr>
				...
				<tr align="center" valign="middle" class="text3">
					...
					<td width="35%" height="32" align="left" bgcolor="#F6F9FE">
						&nbsp;&nbsp;
						<input name="openClinicInfo.actualStartTime" id="openClinicInfo.actualStartTime" type="text" class="input1 Wdate validate[]" onFocus="WdatePicker({isShowClear:false,readOnly:true});"/>
					</td>
					<td width="15%" height="32" align="right" bgcolor="#F6F9FE">实际结束时间<span class="text4"></span>：</td>
					<td width="35%" height="32" align="left" bgcolor="#F6F9FE">
						&nbsp;&nbsp;
						<input name="openClinicInfo.actualEndTime" id="openClinicInfo.actualEndTime" type="text" class="input1 Wdate validate[]" onFocus="WdatePicker({isShowClear:false,readOnly:true});"/>
					</td>
				</tr>
				...
				<tr align="center" valign="middle" class="text3">
					...
					<td width="35%" height="32" align="left" bgcolor="#F6F9FE">
						&nbsp;&nbsp;
						<s:select list="#{'已下发':'已下发'}" listKey="key" listValue="value" cssStyle="width:100px;" theme="simple"
