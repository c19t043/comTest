...
<head>
    ...
    <script type="text/javascript">
        ...
        window.addEvent('domready', function(){
            ...
            if("${phPostpartumFollowRecord.classify}"!=''){
                ...
                if("${phPostpartumFollowRecord.classify}"=="异常"){
        ...
        function doBack(){
        	...
        	window.location.href = "${pageContext.request.contextPath}/productionvisit/postpartumVisit/toList.action"
        			...
        			+ "&phPostpartumFollowRecord.followUpOpportunity=0";
        }
        function doSubmit() {
    ...
    $j(function(){
        ...
        //所有异常和未见异常
        $j('.breast,.lochia,.uterus,.wound,.classify').click(function(){
            if($j(this).val()=='未见异常'){
...
<div class="eXtremeTable">
    ...
    <table width="100%" class="tableRegion2">
        ...
        <tr>
            ...
            <td>
                <input type="text" name="phPostpartumFollowRecord.temperature" value="${phPostpartumFollowRecord.temperature}" class="validate['number','length[5]'] text3"><span>℃</span>
            </td>
        </tr>
        <tr>
