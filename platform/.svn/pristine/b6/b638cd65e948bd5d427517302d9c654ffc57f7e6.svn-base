		...
		<table width="100%" height="45"  border="0" cellpadding="1" cellspacing="1" bgcolor="#B7C6DD">
			<tr align="center" valign="middle" bgcolor="#F6F9FE">
				<td height="43" align="center" class="text3">
					<s:form action="/tohome/orderInfoManager/getOrderInfoList.action" name="query_list_form" id="query_list_form" theme="simple">
						<table width="98%"  border="0" cellpadding="0" cellspacing="0" class="text3">
							<tr>
								<td width="8%" height="41" align="right">订单编号：</td>
								<td width="12%" align="left">
									<input name="orderInfo.orderNum" id="orderInfo.orderNum" type="text" class="input1" value="${orderInfo.orderNum}"/>		
								</td>
								<td width="8%" height="41" align="right">宝宝姓名：</td>
								<td width="12%" align="left">
									<input name="orderInfo.userInfo.babyName" id="babyName" type="text" class="input1" value="${orderInfo.userInfo.babyName}"/>		
								</td>
								<td width="8%" height="41" align="right">医生姓名：</td>
								<td width="12%" align="left">
									<input name="orderInfo.doctorInfo.doctorName" id="doctorInfo.doctorName" type="text" class="input1" value="${orderInfo.doctorInfo.doctorName}"/>		
								</td>
								<%-- <td width="8%" height="41" align="right">订单状态：</td>
								<td width="12%" align="left">
									<s:select cssStyle="width:100px;" cssClass="text3" list="#{'':'请选择','已接单':'已接单','用户取消':'用户取消','已签到':'已签到','已确认':'已确认','已完成':'已完成'}" listKey="key" listValue="value" 
										theme="simple" name="orderInfo.status" value="orderInfo.status"/>
								</td> 
								<td width="8%" height="41" align="right">上门日期：</td>
								<td width="12%" align="left">
									<input type="text" name="orderInfo.bespokeDate" value="${orderInfo.bespokeDate}"
                       					class="text3 Wdate" onFocus="WdatePicker({isShowClear:true,dateFmt:'yyyy-MM-dd',readOnly:true});">
								</td>--%>
					...
					<div class="eXtremeTable">
						<s:if test="#request.list.size>0">
							<com.java.ec:table items="list" var="o" tableId="list" border="0"
								action="${pageContext.request.contextPath}/tohome/orderInfoManager/getOrderInfoList.action"
								...
								<com.java.ec:row>
									...
									<com.java.ec:column property="userInfo.phone" title="手机号" width="10%"/>
									<com.java.ec:column property="submitTime" title="下单时间" width="10%"/>
									<com.java.ec:column property="totalPrice" title="订单金额" width="5%"/>
									<com.java.ec:column property="bespokeDate" title="预约日期" width="5%"/>
									<com.java.ec:column property="product.name" title="服务产品" width="10%"/>
									<com.java.ec:column property="bespokeTime" title="服务时间区间" width="5%"/>
...
<script type="text/javascript">
	...
	function doEdit(action) {
		...
		window.location.href=action + "?orderInfo.id="+items;
	}
</script>