	...
	<head>
		...
		<!--<script type="text/javascript" src="${pageContext.request.contextPath}/platform/theme/public_js/utils2.js"></script>-->
  		...
  		<script type="text/javascript">
			...
			//返回
			function doBack(){
				window.location.href = "${pageContext.request.contextPath}/familydoctor/fdRoleInfo/getFdRoleInfList.action";
			}
  	...
  	<body>
		...
		<form id="form_handle" name="form_handle" action="<s:url namespace="/familydoctor/fdRoleInfo" action="saveOrUpdateFdRoleInfo" includeParams="true"/>" method="post" >
			<input name="save" id="save" type="submit" value="save" style="display: none;">
			<input type="hidden" name="fdRoleInfo.id" value="${fdRoleInfo.id}">
				...
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
					...
					<table width="100%" class="tableRegion2">
						<tr>
							...
							<td width="30%">
								<input type="text" name="fdRoleInfo.roleName" value="${fdRoleInfo.roleName}" class="validate['required','length[20]'] text3">
								<span class="text4">*</span>
							</td>
					  	</tr>
					  	<tr>
							<td class="inputLabel">角色编码：</td>
							<td width="30%" >
								<input type="text" name="fdRoleInfo.roleCode" value="${fdRoleInfo.roleCode}" class="validate['length[20]'] text3" width="70%">
							</td>
					  	</tr>
					  	<tr>
							<td width="15%" height="32" align="right" bgcolor="#F6F9FE">备注信息：</td>
							<td width="85%" height="32" align="left" bgcolor="#F6F9FE" colspan="3">
								<textarea name="fdRoleInfo.remark" class="validate['length[200]'] Added_textarea">${fdRoleInfo.remark}</textarea>
							</td>
					  	</tr>
					</table>
				<br>
