...
/**
 * 机构套餐儿保项目执行记录
 * OrganSetChildCareRecode entity. @author MyEclipse Persistence Tools
 */

public class OrganSetChildCareRecode implements java.io.Serializable {
	private static final long serialVersionUID = 1L;
	private Long id;
	private ChildcareProject childcareProject;
	private UserChildcareAppointmentInfo userChildcareAppointmentInfo;
	private String remark;
	private String isDoneAll;
	...
	public String getIsDoneAll() {
		return this.isDoneAll;
	}

	public void setIsDoneAll(String isDoneAll) {
		this.isDoneAll = isDoneAll;
	}
