					...
					<div class="eXtremeTable">
						<s:if test="#request.list.size>0">
							<com.java.ec:table items="list" var="p" tableId="list" border="0"
								...
								<com.java.ec:row onclick="parent.insertObject('${p.id }','${p.subject }')">
									...
									<com.java.ec:column property="answer" title="答案" width="10%"/>
									<com.java.ec:column property="anexplain" title="答案解释" width="10%"/>
									<com.java.ec:column property="null" title="是否删除" width="10%">
										<c:if test="${p.isdelete == '0' }">未删除</c:if>
										<c:if test="${p.isdelete == '1' }">删除</c:if>
									</com.java.ec:column>
								</com.java.ec:row>
							</com.java.ec:table>
						</s:if>
