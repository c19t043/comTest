...
public class DoctorMorePracticeOrgInfo implements java.io.Serializable {
	...
	/**
	 * 只是前台页面用于控制是否可坐诊（true：可以；false：不可以）
	 */
	private Boolean isCanClinic;
	...
	public Boolean getIsCanClinic() {
		return isCanClinic;
	}

	public void setIsCanClinic(Boolean isCanClinic) {
		this.isCanClinic = isCanClinic;
	}
