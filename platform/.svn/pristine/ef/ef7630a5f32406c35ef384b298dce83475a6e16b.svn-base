...
<html>
	<head>
  	...
  	<body>
		...
		<form id="form_add" class="form" action='<s:url namespace="/operationmanage" action="addingCustomer" includeParams="true"/>' method="post">
			...
			<table width="100%" border="0" cellpadding="1" cellspacing="1" bgcolor="#B7C6DD">
				...
				<tr align="center" valign="middle" class="text3">
					...
					<td width="35%" height="32" align="left" bgcolor="#F6F9FE">
						&nbsp;&nbsp;
						<input name="customer.birthday" id="customer.birthday" type="text" class="input1 Wdate validate['required']" onFocus="WdatePicker({isShowClear:false,readOnly:true});"/>
					</td>
				</tr>
				<tr align="center" valign="middle" class="text3">
				...
				<tr align="center" valign="middle" class="text3">
					...
					<td width="35%" height="32" align="left" bgcolor="#F6F9FE">
						...
						<s:select list="hospitalBasicInfoList" headerKey="" headerValue="--请选择--" listKey="id" listValue="hospitalLname" cssStyle="width:200px;" theme="simple"
						  		  name="customer.hospitalBasicInfo.id" />
					</td>
				</tr>
				<tr align="center" valign="middle" class="text3">
