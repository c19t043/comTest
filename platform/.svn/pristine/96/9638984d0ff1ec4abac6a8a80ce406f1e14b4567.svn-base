				...
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
					...
					<table width="100%" class="tableRegion2">
						<tr>
							...
							<td width="30%">
								<s:select cssStyle="width:100px;" cssClass="text3" list="#doctorInfos" listKey="id" listValue="doctorName" 
									theme="simple" name="consultDoctorInfo.doctorInfo.id" 
									/>
							...
							<td width="30%" >
								<input type="text" name="consultDoctorInfo.serviceLength" value="" class="validate['length[20]'] text3" width="70%">
							</td>
					  	</tr>
					  	<tr>
							<td class="inputLabel">咨询费:</td>
							<td width="30%" >
								<input type="text" name="consultDoctorInfo.consultMoney" value="" class="validate['length[20]'] text3" width="70%">
							</td>
							
							<td class="inputLabel">分成比例：</td>
							<td width="30%" >
								<input type="text" name="consultDoctorInfo.consultCommission" value="" class="validate['length[20]'] text3" width="70%">
							</td>
					  	</tr>
					  	<tr>
					  	...
					  	<tr>
							...
							<td width="30%" >
								<input type="text" name="consultDoctorInfo.recommendMoney" value="" class="validate['length[20]'] text3" width="70%">
							</td>
					  	</tr>
					</table>
				<br>
