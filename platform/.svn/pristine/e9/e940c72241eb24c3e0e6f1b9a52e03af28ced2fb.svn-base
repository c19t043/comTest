...
// 				window.location.href=action;
				var action = '<s:url namespace="/familydoctor/memberskill" action="getFdMemberSkillList" includeParams="true"/>';
				window.location.href=action + "?skillName.id="+id;
			}
			// 新增信息 
			...
			function doEdit(action) {
				...
				window.location.href=action + "?fdMemberSkill.id="+id;
			}
  		</script>
	</head>
		...
		<table width="100%" height="45"  border="0" cellpadding="1" cellspacing="1" bgcolor="#B7C6DD">
			<tr align="center" valign="middle" bgcolor="#F6F9FE">
				<td height="43" align="center" class="text3">
					<s:form action="/familydoctor/memberskill/getFdMemberSkillList.action" name="query_list_form" id="query_list_form" theme="simple">
						<table width="98%"  border="0" cellpadding="0" cellspacing="0" class="text3">
							<tr>
								<td width="10%" height="41" align="right">技能名称：</td>
								<td width="10%" align="left">
									<input type="text" name="fdMemberSkill.skillName" id="skillName" value="${fdMemberSkill.skillName}" class="text3">
								</td>
					...
					<div class="eXtremeTable">
						<s:if test="#request.list.size>0">
							<com.java.ec:table items="list" var="p" tableId="list" border="0"
								action="${pageContext.request.contextPath}/familydoctor/memberskill/getFdMemberSkillList.action"
								...
								<com.java.ec:row>
									...
									<com.java.ec:column property="skillName" title="技能名称" width="10%"/>
									<com.java.ec:column property="skillCode" title="技能编码" width="10%"/>
