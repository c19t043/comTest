...
/**
 * OrderArchive entity. @author MyEclipse Persistence Tools
 */

public class OrderArchive implements java.io.Serializable {
	...
	/** full constructor */
	public OrderArchive(String orderNum, Long userId, Long doctorId,
