...
public class HttpPost {
	...
	public static String doGetWxMedia(String requrl,Map<?,?> parameters,String recvEndcoding,String destDir,String fileName){
		HttpURLConnection url_con=null;
	...
	public static String doPostXml(String reqUrl, String parameters, String recvEncoding) {
		HttpURLConnection url_con = null;
		String responseContent = null;
		try {
			StringBuffer params = new StringBuffer();
			...
			url_con.setReadTimeout(HttpPost.readTimeOut);
			url_con.setDoOutput(true);
            url_con.setRequestProperty("Pragma:", "no-cache");
            url_con.setRequestProperty("Cache-Control", "no-cache");
            url_con.setRequestProperty("Content-Type", "text/xml");
            byte[] b = params.toString().getBytes();
			url_con.getOutputStream().write(b, 0, b.length);
			url_con.getOutputStream().flush();
			url_con.getOutputStream().close();
