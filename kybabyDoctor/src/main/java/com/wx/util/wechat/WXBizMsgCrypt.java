...
public class WXBizMsgCrypt {
	...
	public WXBizMsgCrypt(String token, String encodingAesKey, String corpId) throws AesException {
		if (encodingAesKey.length() != 43) {
			...
			System.out.println("___________________"+encodingAesKey);
	...
	String decrypt(String text) throws AesException {
		...
		try {
			...
			original = cipher.doFinal(parseHexStr2Byte(parseByte2HexStr(encrypted)));
		} catch (Exception e) {
			e.printStackTrace();
