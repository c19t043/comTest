...
/**
 * @ClassName:MommyPostInfoLabelDao
 * @Description:帖子标签的数据管理接口
 * @author Hoolee
 * @date 2015年12月29日上午10:56:46
 */
public interface MommyPostInfoLabelDao{
	 ...
	 * @param mommyPostInfoLabelInstance 待添加的医生圈标签的实例
	 */
	void addNewMommyPostInfoLabelInstance(MommyPostInfoLabel mommyPostInfoLabelInstance);
	 ...
	 * @param mommyPostInfoId 某个帖子的ID
	 */
	void deleteSomeMommyPostInfoLabels(long mommyPostInfoId);
}
