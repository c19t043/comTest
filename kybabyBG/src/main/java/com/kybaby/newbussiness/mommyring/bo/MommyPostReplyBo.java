...
/**
 * @ClassName:MommyPostReplyBo
 * @Description:帖子回复事物管理接口
 * @author Hoolee
 * @date 2015年12月13日下午6:05:04
 */
public interface MommyPostReplyBo {
	 ...
	 */
	void addNewMommyPostReply(long postId,long replyId,String isPoint,long createPerson,String isAllowReply,String isAudit,String dataStatus,String replyContent);
	 ...
	 * @param mommyPostInfoId 回复的帖子的ID
	 * @param userId 医生的ID
	 * @return 删除用户点赞的状态，即删除是否成功
	 */
	boolean deleteSomeMommyPostReply(long mommyPostInfoId,long userId);
}
