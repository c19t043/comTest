...
public class Product implements java.io.Serializable {
	 ...
	 * 产品历史价格说明
	 */
	private String historyPriceRemark;
	...
	public String getHistoryPriceRemark() {
		return historyPriceRemark;
	}

	public void setHistoryPriceRemark(String historyPriceRemark) {
		this.historyPriceRemark = historyPriceRemark;
	}
