...
public interface DoctorInfoDao {
	...
	List getOneDoctorSomeDayInfo(Long a, String serviceDate, Long serviceTimes,Long hour);
	 ...
	 * @data: 2015年9月28日11:27:55
	 */
	void addNewDoctorAccount(DoctorAccount doctorAccount);
