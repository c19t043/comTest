...
public class RecommentAwardRecord implements java.io.Serializable {
	...
	private UserInfo beenRecommendUser;
	private DoctorInfo recommendDoctor;
	private DoctorInfo beenRecommendDoctor;
	...
	public void setRecommendUser(UserInfo recommendUser) {
		this.recommendUser = recommendUser;
	}

	public UserInfo getBeenRecommendUser() {
		return beenRecommendUser;
	}

	public void setBeenRecommendUser(UserInfo beenRecommendUser) {
		this.beenRecommendUser = beenRecommendUser;
	}

	public DoctorInfo getRecommendDoctor() {
		return recommendDoctor;
	}

	public void setRecommendDoctor(DoctorInfo recommendDoctor) {
		this.recommendDoctor = recommendDoctor;
	}

	public DoctorInfo getBeenRecommendDoctor() {
		return beenRecommendDoctor;
	}

	public void setBeenRecommendDoctor(DoctorInfo beenRecommendDoctor) {
		this.beenRecommendDoctor = beenRecommendDoctor;
	}
